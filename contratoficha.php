...
//include("config.php"); // A MINHA CONEXÃO FICOU EM CONFIG.PHP
           ...
           $contrato = $contratoController->getContrato($codigo);
           $cc = new ClienteController();
           $cliente = new Cliente();
           $cliente = $cc->getCliente($contrato->getCliente()->getCdCliente());
...
// *******************************************************************************************
                ...
                $pdf->SetX(85);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('CONTRATO'),0,'L',false);
                ...
                $pdf->SetX(15);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('CONTRATO Nº'),0,'L',false); //


                $pdf->SetY(115);
                $pdf->SetX(26);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('PLANO'),0,'L',false); //


                $pdf->SetY(115);
                $pdf->SetX(124);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('VALOR'),0,'L',false); //


                $pdf->SetY(120);
                $pdf->SetX(10);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('Nº DE PARCELA'),0,'L',false); //
                ...
                $pdf->SetX(17);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('JUROS/MÊS'),0,'L',false); //

                $pdf->SetY(125);
                $pdf->SetX(100);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('DATA DO CONTRATO'),0,'L',false); //

                $pdf->SetY(130);
                $pdf->SetX(24);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(40,6,utf8_decode('STATUS'),0,'L',false); //
...
//DADOS DO CONTRATO
                ...
                $pdf->SetY(110.5);
                $pdf->SetX(43);
                $pdf->MultiCell(35,5,$contrato->getCdContrato(),0,'L',false); //


                $pdf->SetY(115.5);
                $pdf->SetX(43);
                $pdf->MultiCell(35,5,utf8_decode($contrato->getPlano()->getDsPlano()),0,'L',false); //

                $pdf->SetFont('Arial','',10);
                $pdf->SetY(115.5);
                $pdf->SetX(139);
                $pdf->MultiCell(35,5,'R$ '.number_format($contrato->getPlano()->getNrValor(),2,',','.'),0,'L',false); //


                $pdf->SetY(120.5);
                $pdf->SetX(43);
                $pdf->MultiCell(35,5,$contrato->getNrParcela(),0,'L',false); //

                $pdf->SetY(120.5);
                $pdf->SetX(139);
                $pdf->MultiCell(35,5,'R$ '.number_format($contrato->getNrValor(),2,',','.'),0,'L',false); //

                $pdf->SetY(125.5);
                $pdf->SetX(43);
                $pdf->MultiCell(35,5,$contrato->getNrJuros(),0,'L',false); //

                $pdf->SetY(125.5);
                $pdf->SetX(139);
                $dataMySQL = explode('-',$contrato->getDhContrato());
                $pdf->MultiCell(35,5,"$dataMySQL[2]/$dataMySQL[1]/$dataMySQL[0]",0,'L',false); //
