...
//include("config.php"); // A MINHA CONEXÃO FICOU EM CONFIG.PHP
           ...
           $contratoList = new ContratoListIterator($lista);
            ...
            $pdf->SetFont('Arial','',8);
                ...
                $pdf->SetX(10);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(25,6,utf8_decode('CÓDIGO'),1,'C',false); // ESTA É A CELULA QUE PODE TER DADOS EM MAIS DE UMA LINHA
                ...
                $pdf->SetX(260);
                //$pdf->Rect(10,$y,25,$l);
                $pdf->MultiCell(25,6,'PARCELAS',1,'C',false); // LABEL TELEFONE
               ...
               while ($contratoList->hasNextContrato()){
                   ...
                   $pdf->SetX(10);
                   //    $pdf->Rect(10,$y,20,$l);
                   $pdf->MultiCell(25,6,$contrato->getCliente()->getCdCliente(),1,'C',false); // ESTA É A CELULA QUE PODE TER DADOS EM MAIS DE UMA LINHA
                   ...
                   $pdf->SetX(260);
                   //$pdf->Rect(129,$y,70,$l)
                   $pdf->MultiCell(25,6,$total,1,'C',false); //Email
