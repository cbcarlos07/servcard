...
if(isset($_POST['vencimento'])){
    $vencimento = json_decode(stripslashes($_POST['vencimento']));
}
...
switch ($acao){
    case 'C':
        add($data, $quite, $valor, $parcela, $cliente, $usuario, $plano);
        break;
    case 'A':
        change($id, $data, $quite, $valor, $parcela, $cliente, $usuario, $plano);
        break;
    case 'E':
        delete($id);
        break;
...
function add($data, $quite, $valor, $parcela, $cliente, $usuario, $plano){
...
function change($id, $data, $quite, $valor, $parcela, $cliente, $usuario, $plano){
    // echo "<script>alert('Adicionar'); </script>";
    require_once "../beans/Contrato.class.php";
    require_once "../controller/ContratoController.class.php";
    require_once "../beans/Cliente.class.php";
